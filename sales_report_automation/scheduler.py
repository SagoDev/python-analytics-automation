...
class Scheduler:
    """
    Scheduler for automated execution of sales report pipeline.
    ...
    def run_pipeline(self) -> None:
        """
        Full execution of the sales report automation pipeline.
        """
        self.logger.info("Starting sales report generation...")
        ...
        try:
            ...
            charts = charts_generator.generate_all(kpis)
    ...
    def _start(self) -> None:
        ...
        """
        self.logger.info("Sales Report Scheduler started...")
        while True:
